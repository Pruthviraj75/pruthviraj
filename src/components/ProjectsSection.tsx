...
const projects = [
  ...
  id: 1,
  title: "Agentix",
  description: "Full-stack AI agent builder platform that enables users to visually design, configure, and deploy AI workflows without coding. Features drag-and-drop workflow editor, Gemini-powered tool generation, real-time streaming chat, API integrations, and scalable backend using Convex with Clerk authentication and Arcjet security.",
  image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&auto=format&fit=crop&q=80",
  tech: ["Next.js", "TypeScript", "React Flow", "Convex", "Clerk", "Gemini API", "Tailwind CSS", "Web Streams API", "Axios", "Arcjet"],
  github: "https://github.com/Pruthviraj75/Agentify_AI",
  live: "https://agentify-ai-zeta.vercel.app/",
  ...
  image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&h=500&auto=format&fit=crop&q=80",
...
},
 {
  id: 3,
  title: "JobConnect",
  description: "Production-grade MERN stack job portal with role-based access for recruiters and candidates. Implements JWT authentication, protected routes, RESTful APIs, and full CRUD operations for job listings and applications with a responsive React + Tailwind UI and Redux state management.",
  image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=800&auto=format&fit=crop&q=80",
  tech: ["React", "Redux Toolkit", "Node.js", "Express.js", "MongoDB", "JWT", "Tailwind CSS", "REST APIs"],
